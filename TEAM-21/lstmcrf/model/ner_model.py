...
class NERModel(BaseModel):
        ...
        with tf.compat.v1.variable_scope("chars"):
            if self.config.use_chars:
                ...
                cell_bw = tf.compat.v1.nn.rnn_cell.LSTMCell(self.config.hidden_size_char,
                        state_is_tuple=True)
                _output = keras.layers.Bidirectional(keras.layers.RNN(
    ...
    def add_logits_op(self):
        ...
        with tf.compat.v1.variable_scope("bi-lstm"):
            ...
            (output_fw, output_bw), _ = keras.layers.Bidirectional(keras.layers.RNN(
    ...
    def add_loss_op(self):
        ...
        if self.config.use_crf:
            log_likelihood, trans_params = tf.compat.v1.estimator.crf.crf_log_likelihood(
    ...
    def predict_batch(self, words):
        ...
        if self.config.use_crf:
            ...
            for logit, sequence_length in zip(logits, sequence_lengths):
                ...
                viterbi_seq, viterbi_score = tf.compat.v1.estimator.crf.viterbi_decode(
                        logit, trans_params)
